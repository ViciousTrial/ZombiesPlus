...
public class LeaperZombieAttackGoal extends Goal  {
    private final Mob mob;
    private LivingEntity target;
    private final float yd;

    public LeaperZombieAttackGoal(Mob mob, float f) {
        this.mob = mob;
        this.yd = f;
    ...
    public void start() {
        ...
        this.mob.setDeltaMovement(vec32.x * 2d, (double)this.yd, vec32.z * 2d);
    }
}
