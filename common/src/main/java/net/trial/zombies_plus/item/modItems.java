...
public class modItems {
     //public static final Supplier<RegistrarManager> MANAGER = Suppliers.memoize(() -> RegistrarManager.get(modMainCommon.MOD_ID));
     
     public static final DeferredRegister<Item> ITEMS =
               DeferredRegister.create(modMainCommon.MOD_ID, Registries.ITEM);
